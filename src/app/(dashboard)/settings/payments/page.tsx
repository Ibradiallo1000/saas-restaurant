...
export default function RestaurantPaymentsSettingsPage() {
  ...
  const { data: variants, isLoading: isLoadingVariants } = useCollection<PaymentVariant>(variantsQuery)
  ...
  const { data: methods } = useCollection<PaymentMethod>(methodsQuery)
  ...
  const { data: configs, isLoading: isLoadingConfigs } =
    useCollection<RestaurantPaymentConfig>(configsQuery)
