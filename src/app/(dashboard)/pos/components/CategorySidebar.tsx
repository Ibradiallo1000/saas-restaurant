...
export default function CategorySidebar({
  ...
  const items = React.useMemo(() => [{ id: "__all__", label: "Tous" }, ...categories.map((category: any) => ({ id: category.id, label: category.name || "Catégorie", imageUrl: category.imageUrl }))], [categories])
