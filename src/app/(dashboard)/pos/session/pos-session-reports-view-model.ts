...
export interface PosSessionReportModel { reference: string; employee: string; schedule: string; status: string; orders: string; payments: string; cash: string; mobileMoney: string; openedAt: string; closedAt: string; variance: string; duration: string; handover?: string; quality: ReportDataQuality }
export interface PosSessionHistoryModel { id: string; reference: string; schedule: string; ordersAndVariance: string; financialDetails?: string; total: string; status: string }
