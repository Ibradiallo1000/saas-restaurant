export type CanonicalOrderErrorCode =
  ...
  | "PRODUCT_NOT_FOUND"
  | "PRODUCT_UNAVAILABLE"
  | "PRODUCT_NOT_ALLOWED_AT_STATION"
  | "CASH_SESSION_NOT_OPEN"
  | "CASH_SESSION_FORBIDDEN"
  | "POS_STATION_INACTIVE"
  | "PREPARATION_STATION_UNAVAILABLE"
  | "INVALID_OPTION"
...
const HTTP_STATUS: Record<CanonicalOrderErrorCode, number> = {
  ...
  PRODUCT_NOT_ALLOWED_AT_STATION: 403,
  CASH_SESSION_NOT_OPEN: 409,
  CASH_SESSION_FORBIDDEN: 403,
  POS_STATION_INACTIVE: 409,
  PREPARATION_STATION_UNAVAILABLE: 409,
  INVALID_OPTION: 422,
