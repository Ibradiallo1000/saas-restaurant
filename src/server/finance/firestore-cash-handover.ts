...
function movement(
  ...
  return {
    ...
    posStationId: String(handover.posStationId || "DEFAULT"),
    posStationName: String(handover.posStationName || "Caisse principale"),
    posStationCode: String(handover.posStationCode || "DEFAULT"),
